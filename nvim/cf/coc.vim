...
let g:coc_global_extensions =['coc-rust-analyzer','coc-tabnine','coc-snippets','coc-cmake','coc-pairs','coc-json','coc-highlight','coc-emoji','coc-lists','coc-yaml','coc-vetur', 'coc-eslint', 'coc-translator' , 'coc-emmet', 'coc-css', 'coc-html','coc-prettier', 'coc-tsserver']
