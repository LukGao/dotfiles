source ~/.config/nvim/init/option.vim
...
source ~/.config/nvim/cf/buffer.vim
source ~/.config/nvim/cf/fzf.vim
source ~/.config/nvim/cf/neomake.vim
source ~/.config/nvim/cf/rainbow.vim
source ~/.config/nvim/cf/startify.vim
source ~/.config/nvim/cf/utf8.vim
source ~/.config/nvim/cf/bookmark.vim
source ~/.config/nvim/cf/go.vim
source ~/.config/nvim/cf/previous.vim
source ~/.config/nvim/cf/translate.vim
source ~/.config/nvim/cf/wordcolor.vim
